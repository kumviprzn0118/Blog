        ...
        <div className={styles.main_content}>
          ...
          <div className={styles.news_p}>
            ...
            <p className={styles.p}>
              ...
              大学の専攻は化学系で、講義も段々難しくなり、研究にも時間を取られ<br />
              プログラミングの知識は化学のことであっという間に埋もれてしまいました。<br />
            </p>
            <h3 className={styles.h3}><i className={styles.check}></i>就職</h3>
            <p className={styles.p}>
              就活で最終的に選んだ会社は、関東にある化学プラントの企業でした。<br />
              しかし、上司が子供に半年間会えてなかったり、月に2日しか休めなかったり等
              様々な実態を知り半年間で辞めてしまいました。<br />
            </p>
